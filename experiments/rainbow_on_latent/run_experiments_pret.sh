...
#!/bin/bash
python atari_rainbow_parallel_training_pretrained.py --task PongNoFrameskip-v4 --log-name $1
python atari_rainbow_parallel_training_pretrained.py --task SeaquestNoFrameskip-v4 --log-name $1
python atari_rainbow_parallel_training_pretrained.py --task MsPacmanNoFrameskip-v4 --log-name $1
python atari_rainbow_parallel_training_pretrained.py --task BreakoutNoFrameskip-v4 --log-name $1
python atari_rainbow_parallel_training_pretrained.py --task EnduroNoFrameskip-v4 --log-name $1
python atari_rainbow_parallel_training_pretrained.py --task QbertNoFrameskip-v4 --log-name $1
python atari_rainbow_parallel_training_pretrained.py --task SpaceInvadersNoFrameskip-v4 --log-name $1
