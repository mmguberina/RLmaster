...
def get_args():
    ...
    parser.add_argument('--use-regularization-on-unsupervised', type=bool, default=False)
...
#    parser.add_argument('--step-per-epoch', type=int, default=100)
    ...
    parser.add_argument('--log-name', type=str, default='rl_parallel_unsupervised_on_256_bottleneck_NO_AUG_NO_REG_01')
