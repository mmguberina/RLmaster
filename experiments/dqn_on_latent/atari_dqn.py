...
from tianshou.env import ShmemVectorEnv, DummyVectorEnv, SubprocVectorEnv, RayVectorEnv
...
def get_args():
    ...
    parser.add_argument('--encoder-path', type=str, default="../latent_only/encoder.pt")
    parser.add_argument(
...
def make_atari_env_premade_encoder(args):
    return wrap_deepmind_premade_encoder(args.task, frame_stack=args.frames_stack, encoder_path=args.encoder_path, device=args.device)

def make_atari_env_watch(args):
    return wrap_deepmind_premade_encoder(
        args.task,
...
#    )
    ...
    # define model
    net = DQNNoEncoder(args.action_shape, args.device).to(args.device)
