#!/bin/bash
python rae_training_like_a_policy.py --task PongNoFrameskip-v4 --log-name $1
python rae_training_like_a_policy.py --task SeaquestNoFrameskip-v4 --log-name $1
python rae_training_like_a_policy.py --task MsPacmanNoFrameskip-v4 --log-name $1
python rae_training_like_a_policy.py --task BreakoutNoFrameskip-v4 --log-name $1
python rae_training_like_a_policy.py --task EnduroNoFrameskip-v4 --log-name $1
python rae_training_like_a_policy.py --task QbertNoFrameskip-v4 --log-name $1
python rae_training_like_a_policy.py --task SpaceInvadersNoFrameskip-v4 --log-name $1
