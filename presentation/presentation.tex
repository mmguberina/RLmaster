...
\begin{figure}[!t]
  ...
  \centering
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/BreakoutNoFrameskip.tex}}}
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/EnduroNoFrameskip.tex}}}\\
  \vspace{-1cm}
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/MsPacmanNoFrameskip.tex}}}
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/PongNoFrameskip.tex}}}\\
    \ref{named}
...
\begin{figure}[!t]
  \captionsetup[subfloat]{position=top,labelformat=empty}
  \centering
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/QbertNoFrameskip.tex}}}
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/SeaquestNoFrameskip.tex}}}\\
  \vspace{-1cm}
    \subfloat[]{  \resizebox{0.4\textwidth}{!}{\input{../thesis_text/figure/pretrained_rl_vs_rl/SpaceInvadersNoFrameskip.tex}}} \\
    \ref{named}
\end{figure}
\end{frame}
