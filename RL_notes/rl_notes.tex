...
\subsubsection{Optimizing the variational lower bound}
...
\subsubsection{Policy gradient vs Q-learning}
\begin{equation}
...
\subsubsection{Benefits of soft optimality}
\begin{itemize}
...
\subsubsection{Why should we worry about learning rewards?}
\paragraph{Imitation learning perspective}
...
\subsubsection{Feature matching IRL}
...
\subsubsection{Learning the optimality variable}
