...
\begin{enumerate}
		...
		\item compute forward messages $ \alpha_{ t } (\bm{s}_{t}) = p (\bm{s}_{t}|\mathcal{O}_{ 1:t-1 })  $
\end{enumerate}
...
&= \int_{}^{} p (\mathcal{O}_{ t+1:T }| \bm{s}_{t+1}) p (\bm{s}_{t+1}| \bm{s}_{t}, \bm{a}_{t}) p (\mathcal{O}_{ 1:T }| \bm{s}_{t}, \bm{a}_{t}) d\bm{s}_{t+1}\\
\end{align}
\begin{align}
