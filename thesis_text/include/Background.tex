...
algorithm that provides a means of finding the optimal policy,$\mathcal \pi*$ .
...
\subsection{Representation models in general}
\label{sub-repr-models-general}
...
\subsection{Representation models for control}
